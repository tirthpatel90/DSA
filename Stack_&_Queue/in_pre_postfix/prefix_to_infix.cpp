// Convert prefix expression to infix expression using a stack
#include <iostream>
#include <stack>
#include <string>
#include <sstream>
...
// Split the input into tokens so we can process it safely.
...
int main() {
    ...
    try {
        cout << "Infix: " << prefixToInfix(expression) << endl;
